        ...
        return Scaffold(
          ...
          bottomNavigationBar: NavigationBar(
            ...
            destinations: const [
              ...
              NavigationDestination(icon: Icon(Icons.play_circle_outline), label: 'Routines'),
              NavigationDestination(icon: Icon(Icons.threed_rotation), label: '3D'),
              NavigationDestination(icon: Icon(Icons.calculate_outlined), label: 'Calculation'),
            ],
          ),
        );
      },
